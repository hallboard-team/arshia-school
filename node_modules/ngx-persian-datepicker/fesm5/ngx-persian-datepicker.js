import { EventEmitter, Component, ViewEncapsulation, ChangeDetectionStrategy, Input, Output, Optional, Inject, ChangeDetectorRef, Injectable, ElementRef, NgZone, InjectionToken, ViewChild, ViewContainerRef, forwardRef, Directive, Renderer2, LOCALE_ID, NgModule } from '@angular/core';
import { DateAdapter, MAT_DATE_FORMATS, MatDialog, MatFormField, MatButtonModule, MatButtonToggleModule, MatDialogModule, MatIconModule, MatOptionModule, MatSelectModule } from '@angular/material';
...
/**
 * @fileoverview added by tsickle
 * Generated from: lib/public_api.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
...
/**
 * @fileoverview added by tsickle
 * Generated from: ngx-persian-datepicker.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */

export { MD_DATEPICKER_SCROLL_STRATEGY, MD_DATEPICKER_SCROLL_STRATEGY_PROVIDER, MD_DATEPICKER_SCROLL_STRATEGY_PROVIDER_FACTORY, MD_DATEPICKER_VALIDATORS, MD_DATEPICKER_VALUE_ACCESSOR, MatDatepickerModulePersian, MdCalendar, MdCalendarBody, MdCalendarCell, MdDatepicker, MdDatepickerContent, MdDatepickerInput, MdDatepickerInputEvent, MdDatepickerIntl, MdDatepickerToggle, MdMonthView, MdYearView, MdLocaleChanger as ɵa, NativeDateAdapter as ɵb, dateFormat as ɵc };
//# sourceMappingURL=ngx-persian-datepicker.js.map
