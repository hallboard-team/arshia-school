...
import { DateAdapter, MatFormField } from '@angular/material';
...
export declare class MdDatepickerInput<D> implements AfterContentInit, ControlValueAccessor, OnDestroy, Validator {
    ...
    constructor(_elementRef: ElementRef, _renderer: Renderer2, _dateAdapter: DateAdapter<D>, _dateFormats: any, _mdFormField: MatFormField);
