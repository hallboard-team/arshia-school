...
public class PhotoModifySaveService(IWebHostEnvironment _webHostEnvironment) : PhotoStandardSize, IPhotoModifySaveService
{
    ...
    public async Task<string> ResizeImageByScale(IFormFile formFile, ObjectId productId, int standardSizeIndex)
    {
        ...
        if (formFile.Length < 300_000)
            return await SaveImageAsIs(formFile, productId, (int)OperationName.Original); // return filePath
        ...
        return await SaveImage(sKData, productId, formFile.FileName, (int)OperationName.ResizeByScale);
    }
    ...
    public async Task<string> ResizeByPixel(IFormFile formFile, ObjectId productId, int widthIn, int heightIn)
    {
        ...
        if (widthIn >= skImage.Width || heightIn >= skImage.Height)
            return await SaveImageAsIs(formFile, productId, (int)OperationName.Original);
        #endregion
        ...
        return await SaveImage(sKData, productId, formFile.FileName, (int)OperationName.ResizeByPixel, widthIn, heightIn);
        #endregion
    }
    ...
    public async Task<string> ResizeByPixel_Square(IFormFile formFile, ObjectId productId, int sideIn)
    {
        ...
        if (sideIn >= Math.Min(skImage.Width, skImage.Height))
            return await CropWithOriginalSide_Square(formFile, productId);
        #endregion
        ...
        return await SaveImage(sKData, productId, formFile.FileName, (int)OperationName.ResizeByPixelSquare, sideIn, sideIn);
        #endregion
    }
    ...
    public async Task<string> Crop(IFormFile formFile, ObjectId productId, int widthIn, int heightIn)
    {
        ...
        return await SaveImage(sKData, productId, formFile.FileName, (int)OperationName.Crop, widthIn, heightIn);
        #endregion
    }
    ...
    public async Task<string> Crop_Square(IFormFile formFile, ObjectId productId, int sideIn)
    {
        ...
        else
        {
            ...
            return await SaveImage(sKData, productId, formFile.FileName, (int)OperationName.Crop, sideIn, sideIn);
        }
    }
    ...
    public async Task<string> CropWithOriginalSide_Square(IFormFile formFile, ObjectId productId)
    {
        ...
        return await SaveImage(sKData, productId, formFile.FileName, (int)OperationName.Crop, side, side);
    }
