...
public interface IManagerRepository
{
    ...
    Task<OperationResult<EnrolledClass>> AddEnrolledClassAsync(AddEnrolledCourseDto managerInput, string targetUserName, CancellationToken cancellationToken);
    ...
    Task<OperationResult<List<ShowClassDto>>> GetTargetMemberClassesAsync(string targetUserName, CancellationToken cancellationToken);
    Task<OperationResult<EnrolledClass>> GetTargetMemberEnrolledClassAsync(string targetUserName, string classTitle, CancellationToken cancellationToken);
