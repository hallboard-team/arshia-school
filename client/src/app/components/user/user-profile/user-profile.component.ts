...
export class UserProfileComponent implements OnInit {
  ...
  // --- متغیرهای مربوط به تغییر رمز عبور ---
  ...
  onProfileUpdate(updatedData: any) {
    this.loading = true;
    // تبدیل دیتا به فرمت مورد نیاز API (اگر لازم است)
    // نکته: اگر کامپوننت فرزند دیتای درست می‌فرستد نیازی به تغییر نیست
    const updateDto = {
      ...updatedData,
  ...
  // --- لاجیک تغییر رمز عبور (بازگردانده شد) ---
  updateMember(): void {
...
//   standalone: true,
//   imports: [
//     CommonModule, NavbarComponent, MatTabsModule,
//     ProfileInfoCardComponent, ProfileEditFormComponent
//     // سایر ایمپورت‌های مربوط به تب رمز عبور و کورس‌ها رو نگه دار
//   ],
//   templateUrl: './user-profile.component.html',
//   styleUrl: './user-profile.component.scss'
// })
...
//   loggedInUserSig = this._accountService.loggedInUserSig;
//   profile: any = null; // تایپ UserProfile بذار
//   loading = true;
...
//       next: (data) => {
//         this.profile = data;
//         // اینجا لاجیک محاسبه سن و آدرس عکس رو میتونی نگه داری یا ببری توی سرویس
//         this.loading = false;
//       },
//       error: () => this.loading = false
//     });
...
//     // کدهای آپلود عکس (از فایل قبلی کپی کن)
//     this._memberService.uploadProfilePhoto(file).subscribe(res => {
//       this.getProfile(); // رفرش پروفایل بعد از آپلود
...
//   onProfileUpdate(updatedData: any) {
//     this.loading = true;
//     this._memberService.updateUser(updatedData).subscribe({
//       next: () => {
//         this._snackBar.open('پروفایل بروز شد', 'باشه', { duration: 4000 });
//         this.getProfile(); // دریافت اطلاعات جدید
//       },
//       error: (err) => {
//         this.loading = false;
//         this._snackBar.open('خطا در بروزرسانی', 'باشه');
//       }
//     });
//   }
// }
